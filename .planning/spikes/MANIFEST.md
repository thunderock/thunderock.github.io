...
| 002 | projects-section-reco | standard | Given the ranked shortlist + milestone research, when Projects-section variants are drafted with line costs, then 2-3 concrete recommendations are presented side-by-side vs current | PENDING | resume, projects, latex |
