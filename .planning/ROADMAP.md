...
- [x] 06-02-PLAN.md — site content sync: Adobe-block rewrite (retired figures gone, torch.compile, Rust governance), Education mirror + hero/about sweep, Projects → rollout+graph_ml, prune Competitive/Certifications, remove career-break (SITE-01, SITE-02)
