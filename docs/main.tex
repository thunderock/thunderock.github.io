...
\section{Work Experience}
  ...
  \resumeSubheading
    ...
    \resumeItemListStart
      \resumeItem{Leading parts of the org's MLOps platform for building, deploying, and monitoring GPU-accelerated data pipelines and model inference on Kubernetes, spanning the full ML lifecycle from data ingestion to inference.}
