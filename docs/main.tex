...
\section{Work Experience}
  ...
  \resumeSubheading
    ...
    \resumeSubheading
      {Career Break for Master's Degree}{}
      {Indiana University, Bloomington}{MASTER OF SCIENCE IN COMPUTATIONAL DATA SCIENCE}
      \resumeItemListStart
        \resumeItem{Full-time graduate study and research; see the Education, Research, and Teaching sections below for coursework, publications, and assistantships from this period.}
      \resumeItemListEnd
